  ...
  return (
    <main className="shell py-10">
      ...
      <form action={updateProductAction} className="card mt-8 grid gap-5 p-6 md:grid-cols-2">
        ...
        <label className="grid gap-2 text-sm font-semibold">SKU<input className={fieldClass} name="sku" defaultValue={product.sku} required /></label>
        <label className="grid gap-2 text-sm font-semibold">Slug<input className={fieldClass} name="slug" defaultValue={product.slug} required /></label>
        ...
        <label className="grid gap-2 text-sm font-semibold">Precio unitario (centavos)<input className={fieldClass} name="unitPriceCents" type="number" min="0" defaultValue={product.unitPriceCents} required /></label>
        <label className="grid gap-2 text-sm font-semibold">Precio pack de 10 (centavos)<input className={fieldClass} name="pack10PriceCents" type="number" min="0" defaultValue={product.pack10PriceCents ?? ""} /></label>
        <label className="grid gap-2 text-sm font-semibold">Costo comercial (centavos)<input className={fieldClass} name="commercialCostCents" type="number" min="0" defaultValue={product.commercialCostCents} required /></label>
